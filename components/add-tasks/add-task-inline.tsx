...
import { CalendarIcon, LucideTableCellsSplit, Text } from "lucide-react";
...
export default function AddTaskInline({
  ...
  const projectId = parentTask?.projectId || GET_STARTED_PROJECT_ID as Id<"projects">;
  const labelId = parentTask?.labelId || "jx7edfp1tvfyf6re3ntt0d5cz5701t5x" as Id<"labels">;
